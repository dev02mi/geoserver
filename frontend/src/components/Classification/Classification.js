...
const Classification = () => {
  ...
  return (
//     <div className="MainDivOfClassification">
        
     
       
     
//      <div className="MainContentOfClassification ">
//           <h1 className='HeadingOfLoadingClassfication'>Hello &nbsp; <strong>Agriculture</strong>  &nbsp; admin user </h1>
//           <p className='PAragraphOfApplicationClassification'>This Page is under Developement!</p>
//         </div>
    
//      <span className='LoadingSpinner'>
//      <div className="LoaderOfClassification">
//           <div className="spinnerOfClassification"></div>
//         </div>
//      </span>
        ...
        <div className="AgriCulTop">
          <div className="headingingOfAgri Text-Center">
            <div className="HeadingForAgriculture p-0">
              <p className="titleOfAgriculture">agriculture And Home</p>
            </div>
            <div className="headingingOfAgri">
              <img
                src="AgricultureHome.jpg"
                alt=""
