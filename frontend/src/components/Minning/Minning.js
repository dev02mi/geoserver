  ...
  return (
    <div className=' MinningHome mx-5'>
        ...
        <div className="HeadingForAgriculture p-0">
              <button className="HeadingForMinning m-5 btn  rounded-pill px-3 p-0">Mining</button>
            </div>
          {/* <div className='HeadingForMinning p-0'><p className='titleOfdefemce' >Mining</p></div> */}
