...
const Ndvi = () => {
  ...
  return (
//     <div className="underConstructionNdvi">
        
     
       
     
//      <div className="MAinContentOfNdvi">
//           <h1 className='HeadingOfLoading'>Hello  &nbsp; <strong>Agriculture</strong>  &nbsp; admin user chhaya </h1>
