...
const Termsacondition = () => {
  return (
    <div className=''>
      <div className='main-containOfPolicies my-auto '>


        <div className='  headingOfCondition  sm-mt-0 sm-pt-0 md-pt-0'>
          <div className='row  d-flex justify-content-center align-items-center'>
            ...
            <div className='col-lg-4 d-flex justify-content-center align-items-center '><h1 class="privacypoliecisheading mt-4">Terms And Condition</h1></div>
            <div
        ...
        <div className='   Disclaimer   text-justify '>
          ...
          <p className='paragraphOfDisclaimer'><strong>Contact Information: </strong>  If you have any questions or concerns about
            this disclaimer, please contact us at [insert contact information].   </p><br></br>
